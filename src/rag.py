"""
Module to manage all RAG functions. Mainly revolves around building up 
...
class RAG():
    ...
    def __init__(self):
        ...
        self.llm = self.graph_builder.llm 
        self.entity_extract_chain = self.create_entity_extract_chain()
    ...
    def create_entity_extract_chain(self):
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    "You are extracting objects, persons, assumptions, explanations, conjectures  " +
    ...
    def structured_retriever(self, question: str) -> str:
        ...
        for entity in entities.names:
            response = self.graph_builder.graph.query(
    ...
    def retriever(self, question: str, vector_index: Neo4jVector) -> str:
        """
